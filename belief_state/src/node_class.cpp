...
krssg_ssl_msgs::BeliefState BeliefState::getBeliefStateMsg(){
	...
	// msg.homePos[2].y = -550;
	// msg.homePos[3].x = 326;
	// msg.homePos[3].y = 1074;
	// msg.homePos[4].x = -1161;
	// msg.homePos[4].y = 1182;
	// msg.homePos[5].x = -1523;
	// msg.homePos[5].y = -380;
